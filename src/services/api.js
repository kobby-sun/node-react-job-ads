...
export const fetchProduct = name => callApi(`products/${name}`)
export const fetchCustomers = () => callApi(`customers`)
export const fetchCustomer = name => callApi(`customers/${name}`)